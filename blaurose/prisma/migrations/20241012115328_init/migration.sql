...
-- CreateIndex
CREATE INDEX "t_timecard_stamped_from_stamped_to_idx" ON "t_timecard"("stamped_from", "stamped_to");

-- CreateIndex
CREATE UNIQUE INDEX "t_timecard_stamped_at_employee_id_key" ON "t_timecard"("stamped_at", "employee_id");
